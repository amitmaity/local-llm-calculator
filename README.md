...
- Includes presets for Llama, Qwen 2.5, Qwen3, Qwen 3.5, Qwen 3.6, Qwen3-Coder-Next, Mixtral, Gemma 2, Gemma 3, Gemma 4, Muse Glimmer, SmolLM, TinyLlama, Phi-3, Phi-4, Command-R, and DeepSeek.
